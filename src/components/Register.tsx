  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
      <motion.div
        ...
        className="pb-15 pt-15 bg-gray-800/90 backdrop-blur-lg rounded-2xl shadow-2xl w-full max-w-md p-8 flex flex-col items-center"
      >
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
          ...
          <div>
            <label className="block text-gray-300 mb-2 text-sm font-medium">Подтвердите пароль</label>
            <input
              type="password"
